    ...
    <>
        ...
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 24px' }}>
          <div className="pillars-grid" data-reveal data-reveal-delay="1">
            <div className="pillar pillar-physical">
              ...
              <p>Your energy is the substrate of everything else. When the body is neglected, focus fades, mood drops, and purpose feels distant. Trinitect keeps physical practice in the equation — not as an add-on, but as a foundation.</p>
              <div className="pillar-examples">
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--physical)', opacity: 0.6, flexShrink: 0 }} />Morning movement block</div>
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--physical)', opacity: 0.6, flexShrink: 0 }} />Cold exposure or breathwork</div>
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--physical)', opacity: 0.6, flexShrink: 0 }} />Nutrition window practice</div>
              </div>
            </div>
            <div className="pillar pillar-mental">
              ...
              <p>Your mind is the lens through which everything passes. The quality of your thinking shapes every decision, every relationship, every goal. Trinitect trains the lens — not just the task list.</p>
              <div className="pillar-examples">
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--mental)', opacity: 0.6, flexShrink: 0 }} />Deep work block</div>
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--mental)', opacity: 0.6, flexShrink: 0 }} />Evening reflection journal</div>
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--mental)', opacity: 0.6, flexShrink: 0 }} />No-screen wind-down</div>
              </div>
            </div>
            <div className="pillar pillar-spiritual">
              ...
              <p>Not religion. Not ritual. The felt sense that what you're doing matters — that you're pointed toward something real. Without it, even peak performance feels hollow. Trinitect keeps that signal alive.</p>
              <div className="pillar-examples">
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--spiritual)', opacity: 0.6, flexShrink: 0 }} />Morning gratitude practice</div>
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--spiritual)', opacity: 0.6, flexShrink: 0 }} />Values alignment check-in</div>
                <div className="pillar-example"><span style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--spiritual)', opacity: 0.6, flexShrink: 0 }} />Intentional silence</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="section-inner">
          ...
          <div className="steps-grid">
            <div className="step" data-reveal data-reveal-delay="1">
              ...
              <p>What actually matters to you? <em>Vitality. Mastery. Freedom. Connection.</em> Twelve options. Your answers shape every pattern we generate — nothing is generic.</p>
            </div>
            <div className="step" data-reveal data-reveal-delay="2">
              ...
              <p>One physical. One mental. One spiritual. Built around what drives you. Not a generic routine — a personalized structure for <em>your</em> specific life.</p>
            </div>
            <div className="step" data-reveal data-reveal-delay="3">
              ...
              <p>That's it. No streaks to chase. No gamification. Just the daily practice of becoming <em>who you said you wanted to be.</em></p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="pattern-section">
        <div data-reveal>
          ...
          <div className="pattern-big">We call them <span>patterns,</span> not habits.</div>
          <p className="pattern-sub" style={{ marginTop: 16 }}>A habit is something you do. A pattern is something you become. The distinction matters.</p>
        </div>
      </section>
        ...
        <div className="section-inner">
          <div className="foundation-inner">
            <div data-reveal>
              ...
              <p className="section-sub">The neuroscience is clear: 21 days of consistent, intentional action begins restructuring neural pathways. Most programs never reach that window because they rely on willpower alone.</p>
              <p style={{ fontSize: 15, color: 'var(--text3)', lineHeight: 1.75, marginTop: 20 }}>Trinitect builds a structure around this window. Not a streak — a foundation. At day 21, something has shifted. Not just behavior. Identity.</p>
            </div>
            <div data-reveal data-reveal-delay="2">
              <div className="foundation-bar-label">Foundation Progress</div>
              <div className="foundation-days">
                {Array.from({ length: 21 }).map((_, i) => (
                  <div key={i} className={`foundation-day ${i < 11 ? 'done' : i === 11 ? 'partial' : 'empty'}`} style={i < 11 ? { opacity: 0.6 + (i / 11) * 0.4 } : {}} />
                ))}
              </div>
              <div className="foundation-count">11 <span>of 21 full days</span></div>
              <p style={{ marginTop: 12, fontSize: 12, fontFamily: 'var(--font-mono)', color: 'var(--text4)', letterSpacing: '0.04em' }}>10 days to Foundation complete</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="final-cta">
        ...
        <div data-reveal>
          ...
          <h2 className="final-h2">The life you want<br />is a pattern problem.</h2>
          <p className="final-sub">Free to begin. No card required.</p>
          <div className="final-cta-links">
            <Link href="/start" className="hero-cta">Start your foundation →</Link>
            <Link href="/login" className="final-cta-secondary">Already have an account? Sign in →</Link>
          </div>
        </div>
      </section>
